...
| 실제 desktop application | 개발 셸 구현·deterministic PASS | macOS 개발 runtime, reviewed bundle picker, preview·apply·validate·rollback, read-only 취소·재실행과 공통 core IPC 검증; package는 미발행 |
