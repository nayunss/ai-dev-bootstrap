...
2026-07-18 공통 risk policy validator는 normal, dependency, security, release, Production, database,
destructive 등급을 분리하고 고위험 등급의 필수 역할·독립 review·최소 승인 수와 emergency
approver·expiry·post-review·rollback을 synthetic fixture로 검증한다. 실제 provider branch policy
변경은 수행하지 않는다.
