...
아래 과정은 `v0.2.9-pilot` source를 고정하고 대상 프로젝트를 읽기 전용으로 검사한다.
...
- 현재 검증 기준: [v0.2.9-pilot](https://github.com/nayunss/ai-dev-bootstrap/releases/tag/v0.2.9-pilot)
...
`v0.2.9-pilot` archive SHA-256은
`3ae9ef8dd024339c4765ddc56e77ecbb724d1d8a51920da02ef86d8ddaff5d69`이다.
...
`v0.2.9-pilot`에는 실제 사용자 프로젝트에 바로 적용할 production release-adoption manifest나
