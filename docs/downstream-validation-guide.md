...
[처음부터 끝까지 사용 가이드](bootstrap-user-guide.md)를 따른다 — 이 문서는 같은 절차를
...
[처음부터 끝까지 사용 가이드](bootstrap-user-guide.md)의 release 고정, 읽기 전용 진단, onboarding,
별도 설치, 검증과 팀 반영 순서를 수행한다. Placeholder·선택 stack·승인 범위는 tester 값으로
채우되 안전 조건과 순서를 약화하지 않는다. 검증 관점에서 각 단계에
추가로 확인할 것:
...
- 관련 요구사항: REQ-001–REQ-008, REQ-033–REQ-038, REQ-042, REQ-045–REQ-046
