...
> 0 routes | 1 models | 0 components | 15 lib files | 2 env vars | 5 middleware
> **Token savings:** this file is ~1,900 tokens. Without it, AI exploration would cost ~13,600 tokens. **Saves ~11,700 tokens per conversation.**
